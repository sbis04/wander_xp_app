        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'FlightInfoPage',
              path: 'flightInfoPage',
              builder: (context, params) => FlightInfoPageWidget(),
            ),
            FFRoute(
              name: 'HotelReservationPage',
              path: 'hotelReservationPage',
              builder: (context, params) => HotelReservationPageWidget(),
            ),
            FFRoute(
              name: 'PlacesToVisitPage',
              path: 'placesToVisitPage',
              builder: (context, params) => PlacesToVisitPageWidget(),
            ),
            FFRoute(
              name: 'TripPage',
              path: 'tripPage',
