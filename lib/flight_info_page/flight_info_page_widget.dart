...
import 'flight_info_page_model.dart';
export 'flight_info_page_model.dart';

class FlightInfoPageWidget extends StatefulWidget {
  const FlightInfoPageWidget({Key? key}) : super(key: key);

  @override
  _FlightInfoPageWidgetState createState() => _FlightInfoPageWidgetState();
}

class _FlightInfoPageWidgetState extends State<FlightInfoPageWidget> {
  late FlightInfoPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FlightInfoPageModel());
                    ...
                    children: [
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: 'Flight Number (Arrival)',
                            labelStyle:
                            ...
                            hintText: 'Enter your arrival flight number',
                            hintStyle:
                                FlutterFlowTheme.of(context).bodyText1.override(
                                      fontFamily: 'Poppins',
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: 'Flight Number (Departure)',
                            labelStyle:
                                FlutterFlowTheme.of(context).bodyText1.override(
                                      fontFamily: 'Poppins',
                                      fontSize: 16,
                            ...
                            hintText: 'Enter your departure flight number',
                            hintStyle:
                                FlutterFlowTheme.of(context).bodyText1.override(
                                      fontFamily: 'Poppins',
                                      color: FlutterFlowTheme.of(context)
                      ...
                      FFButtonWidget(
                        onPressed: (_model.textController1.text == null ||
                            ...
                            : () async {
                                ...
                                context.pushNamed('HotelReservationPage');
                              },
                        text: 'Next: Hotel Reservation',
